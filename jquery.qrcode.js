...
for (function(a) {
    a.fn.qrcode = function(b) {
        ...
        d = function() {
            ...
            if( b.src ) {
            	b.imgWidth = b.imgWidth || b.width / 4.7;
            	b.imgHeight = b.imgHeight || b.height / 4.7;
            	var $img = $('<img>').attr("src", b.src)
        	    	.css("width", b.imgWidth)
        	    	.css("height", b.imgHeight)
        	    	.css("position", "absolute")
        	    	.css("left", (b.width - b.imgWidth) / 2)
        	    	.css("top", (b.height - b.imgHeight) / 2);
            	d = $('<div style="position:relative;"></div>')
        	    	.append(d)
        	    	.append($img);
        	}
            return d
